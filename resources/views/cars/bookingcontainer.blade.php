<section class="ftco-section bg-light">
    <div class="container">
        <div class="column" style="width: 100%">
            ...
            <div style="width: 100%">
                <img src="/car_images/{{$car->image}}" alt="Car Image" height="200px" width="200px" style="object-fit: cover; border:2px solid; border-radius:50%; margin:0 auto">
            </div>
            
            <form action="{{route('book_now', $car->id)}}" method="post">
                @csrf
                ...
                <div class="mt-5" style="border: 2px solid">
                    ...
                    <div class="row">
                        ...
                        <div style="width: 50%; text-align: center">
                            <input style="width: 150px; height: 25px; text-align: center" type="number" name="quantity" id="quantity" min="1" max="{{$car->totalCars}}" required>
                        </div>
                    </div>
                    <div class="row">
                        <h5 style="width: 50%; text-align: center">Date:</h5>
                        <div style="width: 50%; text-align: center">
                            <input style="width: 150px; height: 25px; text-align: center" type="date" name="date" id="date" min="{{date('Y-m-d')}}" required>
                        </div>
                    </div>
                    <div class="row">
                        <h5 style="width: 50%; text-align: center">Days:</h5>
                        <div style="width: 50%; text-align: center">
                            <input style="width: 150px; height: 25px; text-align: center" type="number" name="days" id="days" min="1" required>
                        </div>
                    </div>
                </div>
                <button class="btn btn-success mt-5" style="background-color:green; margin-left:46%" type="submit">Book Car</button>
            </form>
